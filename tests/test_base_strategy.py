...
def setup_buy_and_sell_strat():
    ...
    test_strat.current_eth = 5.0
    return test_strat

def test_buy_eth():
    """
    Test that buying ETH works.
    """
    # test_strat.current_price = 25
    # test_strat.current_usd/starting_usd = 100
    # test_strat.current_eth = 5
...
def test_buy_too_much():
    ...
    try:
        test_strat = setup_buy_and_sell_strat()
        test_strat.buy_eth(eth_to_buy=4.0001)
        failed = False
